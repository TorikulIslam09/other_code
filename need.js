...
//------------------------- custom stickyHeder ---------	
		...
		window.onscroll = function() {stickyHeder()};

		var header = document.getElementById("stickyheder");
...
// -----------------------lodmore-----------
        $(function () {
			$(".reviews_section .Reviews_inner").slice(0, 4).show();
			$("#loadMore").on('click', function (e) {
				e.preventDefault();
				$(".reviews_section .Reviews_inner:hidden").slice(0, 4).slideDown();
				if ($(".reviews_section .Reviews_inner:hidden").length == 0) {
...
// suggested: https://codepen.io/elmahdim/pen/AvgvrL
  ...
  // vision page counter
  {
    let visionCounter = document.querySelector(".counter-valuee");
  
    if (visionCounter != null) {
      $(".counter-valuee").each(function () {
        var $this = $(this),
  ...
  link.href = 'https://bongoitltd.com/assets/img/logo/favicon.png';
